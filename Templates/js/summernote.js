...
(function (factory) {
  ...
  var settings = {
     ...
     */
    options: {
      width: 950,                  // set editor width
      height: 520,                 // set editor height, ex) 300
    ...
    lang: {
      'zh-TW': {
        ...
        image: {
          ...
          resizeFull: '重設大小至原圖',
          resizeHalf: '重設大小至1/2',
          resizeQuarter: '重設大小至1/4',
          floatLeft: '靠左浮動',
          floatRight: '靠右浮動',
          floatNone: '取消浮動',
          shapeRounded: '形狀：圓角矩形',
          shapeCircle: '形狀：圓形',
          shapeThumbnail: '形狀：加框',
          shapeNone: '形狀：無',
          dragImageHere: 'Drag an image here',
          selectFromFiles: 'Select from files',
          url: '圖片網址  (善用 <a target="new" href="http://imgur.com/"> Imgur </a>)',
          remove: '移除圖片'
        },
        link: {
          link: '超連結',
